...
public sealed class ReleaseNotesCatalogTests
{
    ...
    {
        Assert.Equal(
            ["2.3.1", "2.3", "2.2", "2.1.2", "2.1.1", "2.1", "2.0.1", "2.0", "1.2.2", "1.2.1", "1.2", "1.1.4", "1.1.3", "1.1.2", "1.1.1", "1.1", "1.0.12", "1.0.11", "1.0.10", "1.0.8", "1.0.7", "1.0.6", "1.0.5", "1.0.4", "1.0.3", "1.0.2", "1.0.1"],
            ReleaseNotesCatalog.Entries.Select(entry => entry.Version));
        Assert.True(ReleaseNotesCatalog.Entries[0].IsCurrent);
        Assert.Equal("GAUGE LAYOUT HOTFIX", ReleaseNotesCatalog.Entries[0].Label);
