...
- Add adjustable smoothing, stable numeric updates, optional signed output, independent attachment and boost-style line colors for power and torque. Preserve recorded telemetry and fixed per-car ranges.
