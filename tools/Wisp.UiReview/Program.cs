    ...
    private static int Main(string[] args)
    {
        try
        {
            ...
            if (options is null)
            {
                ...
                Console.WriteLine("--scroll-check measures bounded offscreen scrolling on Dashboard, Appearance, Diagnostics, and Setup at 720x440 and 980x750, direct Viewbox versus a temporary Decorator. --scope and --step are rejected; no PNGs are produced.");
