...
Drift mode keeps the power and torque gauges readable during brief power cuts.

- Enable **Drift mode** in **Appearance > Gauges > Engine output > More options** to hold the power and torque numbers and needles through brief cuts in combustion cars. The numbers pulse while the output is held.
