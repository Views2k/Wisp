...
- Identify an upper-range target separately when the measured curve does not show an acceleration crossover. Driver reaction, changing grip and boost recovery can affect the best time to shift; these targets do not predict every racing condition.
