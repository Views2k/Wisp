...
- An optional welcome banner offers a four-step tour of Dashboard, Appearance, Runs and connection help. Skip or dismiss it at any time, or replay it from Release Notes. It does not interrupt automatic game-triggered launches.
...
These fixes address specific measured defects; they are not a guarantee of zero frame-rate impact on every computer.
