        ...
        new(
            ...
            [
                Group("Added",
                    ...
                    "Continuous color controls cover the app accent, background surfaces, HUD border, and all three gauge-gradient colors, including saturation, brightness, and opacity.",
                ...
                Group("Fixed and refined",
                    ...
                    "Combined the six color editors into one focused card with a clear target selector.",
